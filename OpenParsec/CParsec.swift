...
class ParsecResolution: Hashable, Identifiable
{
	var id: UUID = .init()
	var width: Int
	var height: Int
...
class CParsec
{
	static var hostWidth: Float
	{
		return parsecImpl.hostWidth
	}

	static var hostHeight: Float
	{
		return parsecImpl.hostHeight
	}

	static var clientWidth: Float
	{
		return parsecImpl.clientWidth
	}

	static var clientHeight: Float
	{
		return parsecImpl.clientHeight
	}

	static var mouseInfo: MouseInfo
	{
